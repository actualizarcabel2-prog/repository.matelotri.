...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR gold][B]Matelotri[/B][/COLOR] [COLOR white]Wizard[/COLOR]'
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Gracias por instalar Matelotri Wizard.\n\nBuild optimizada para Kodi con Arctic Zephyr - Reloaded.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR gold][B]Matelotri[/B][/COLOR] [COLOR white]Wizard[/COLOR]'
